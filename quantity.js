        ...
        case 'L':
            ...
            switch (LengthCon) {
                ...
                case 'm':
                    ...
                    switch (Meter) {
                        case 'i':
                            unitOperations.meterToInchConversion(meterValue).then((data) => {
                                console.log(data)
                            }).catch((error) => {
                                console.error(error);
                            })
                            break;
                        case 'ft':
                            unitOperations.meterToFeetConversion(meterValue).then((data) => {
                                console.log(data)
                            }).catch((error) => {
                                console.error(error);
                                unitConversion();
                ...
                case 'i':
                    ...
                    switch (Inch) {
                        case 'm':
                            unitOperations.inchToMeterConversion(inchValue).then((data) => {
                                console.log(data);
                            }).catch((error) => {
                                console.log(error);
                            })
                            ...
                            break;
                        case 'ft':
                            unitOperations.inchToFeetConversion(inchValue).then((data) => {
                                console.log(data);
                            }).catch((error) => {
                                console.log(error);
                            })
        ...
        case 'T':
            ...
            switch (TempretureCon) {
                ...
                case 'cl':
                    ...
                    switch (Celsius) {
                        case 'fa':
                            unitOperations.celsiusToFahrenheitConversion(celsiusValue, function printCallback(){
                                console.log("Please Enter Possitive Value");
                            })
                            break;
                        case 'kl':
